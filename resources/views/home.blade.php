...
@section('content')
    ...
    <div class="customer-info">
        ...
        <p class="customer-info-text">試合終了後、スムーズな会場運営にご協力をお願いいたします。</p>
        <p class="customer-info-text">退出に関する重要事項は以下の通りです</p>
        <p class="customer-info-text">試合終了後30分間は無料でお過ごしいただけます。30分を超過した場合、10分ごとに100円の延長料金が発生いたします。お時間に余裕を持ってのご退場にご協力いただけますと幸いです。ご理解とご協力をお願い申し上げます。</p>
    </div>
@endsection
